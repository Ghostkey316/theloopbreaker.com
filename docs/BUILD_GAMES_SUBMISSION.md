...
Fuji deployment addresses will be populated after running the deployment script. See `deployments/fuji-deployment.json` for the full manifest after deployment.
...
**Total: 346 Hardhat tests passing.**
