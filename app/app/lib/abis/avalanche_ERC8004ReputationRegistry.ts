// ABI for ERC8004ReputationRegistry on avalanche
// Auto-fetched from Etherscan V2 API
export const ERC8004ReputationRegistry_avalanche_ABI = [
  {
    "inputs": [
      {
