// ABI for ERC8004ValidationRegistry on avalanche
// Auto-fetched from Etherscan V2 API
export const ERC8004ValidationRegistry_avalanche_ABI = [
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum ERC8004ValidationRegistry.ValidationStatus",
        "name": "finalStatus",
        "type": "uint8"
      },
      {
  ...
  },
  {
    ...
    "name": "getAgentValidationRequestsCount",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "count",
  ...
  },
  {
    ...
    "name": "getAgentValidationRequestsPaginated",
    "outputs": [
      {
        "internalType": "uint256[]",
        "name": "page",
  ...
  },
  {
    ...
    "name": "getValidationResponsesCount",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "count",
  ...
  },
  {
    ...
    "name": "getValidationResponsesPaginated",
    "outputs": [
      {
        "internalType": "uint256[]",
        "name": "page",
  ...
  },
  {
    ...
    "name": "validatorActiveValidations",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract BeliefAttestationVerifier",
        "name": "",
        "type": "address"
      }
    ],
