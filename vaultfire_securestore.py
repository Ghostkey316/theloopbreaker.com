...
class SecureStore:
    ...
    def __init__(
        ...
        *,
        ...
        self.retry_dir = (retry_dir or (self.bucket / "retries")).resolve()
    ...
    def _record_intent(self, status: str, metadata: dict, *, reason: Optional[str] = None) -> None:
        ...
        try:
            ...
            self.intent_logger(decision)
        except Exception:
            # Intent logging must never break secure storage writes.
            pass
    ...
    def encrypt_and_store(
        ...
        *,
        ...
        # If we reached here, we could not store successfully.
